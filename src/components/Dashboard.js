  ...
  return (
    <div className="dashboard-container">
      ...
      {loading ? (
        ...
        <>
          <Cards currentBalance={currentBalance} income={income} expenses={expenses} showExpenseModal={showExpenseModal} showIncomeModal={showIncomeModal} cardStyle={cardStyle} reset={reset} />
            ...
            <>
              <Row gutter={16}>
                ...
                <Card bordered={true} style={{ ...cardStyle, flex: 0.45 }}>
                  ...
                  {spendingDataArray.length == 0 ? <p>Seems like you haven't spent anything till now...</p> : <Pie {...{ ...spendingConfig, data: spendingDataArray }} />}
                </Card>
              </Row>
            </>
          )}
          <TransactionSearch transactions={transactions} exportToCsv={exportToCsv} fetchTransactions={fetchTransactions} addTransaction={addTransaction} />
        </>
      )}
    </div>
  );
